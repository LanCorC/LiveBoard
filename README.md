...
Old installation [(Docker)](https://github.com/LanCorC/LiveBoard/blob/master/OLDINSTALL.md).
...
5. Visit your private lobby through http://localhost:5000/
